...
project = u'DMRG.x'
copyright = u'2018, James Vance'
author = u'James Vance'
...
latex_documents = [
    (master_doc, 'DMRGx.tex', u'DMRG.x Documentation',
     u'James Vance', 'manual'),
]
...
man_pages = [
    (master_doc, 'dmrgx', u'DMRG.x Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'DMRGx', u'DMRG.x Documentation',
     author, 'DMRGx', 'One line description of project.',
     'Miscellaneous'),
]
